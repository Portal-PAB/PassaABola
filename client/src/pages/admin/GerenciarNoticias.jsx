...
function GerenciarNoticias() {
  ...
  const [imagens, setImagens] = useState(['']); // Começa com um campo para URL de imagem
  ...
  const addCampoImagem = () => {
    // Adiciona apenas se o último campo não estiver vazio, para evitar campos em branco
  ...
  const handleSubmit = async (event) => {
    ...
    const noticiaData = {
      ...
      resumo,
      conteudo,
      // Filtra para não enviar campos de imagem vazios
